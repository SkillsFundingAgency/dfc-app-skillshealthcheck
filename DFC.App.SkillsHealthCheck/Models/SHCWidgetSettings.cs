...
namespace DFC.App.SkillsHealthCheck.Models
{
    public class SHCWidgetSettings
    {
        ...
        public static List<SHCWidgetSettings> SHCWidgetSettingsList = new List<SHCWidgetSettings>
        {
                ...
                new SHCWidgetSettings { SHCAssessmentType = AssessmentType.Interests, StartLinkText = StartInterestsDescription, ContinueLinkText = ContinueInterestsDescription, CompleteLinkText = CompletedInterestsDescription },
                ...
                new SHCWidgetSettings { SHCAssessmentType = AssessmentType.Numerical, StartLinkText = StartNumericalDescription, ContinueLinkText = ContinueNumericalDescription, CompleteLinkText = CompletedNumericalDescription },
