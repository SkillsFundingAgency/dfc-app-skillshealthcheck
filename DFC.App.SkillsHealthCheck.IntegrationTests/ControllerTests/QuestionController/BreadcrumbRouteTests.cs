...
namespace DFC.App.SkillsHealthCheck.IntegrationTests.ControllerTests.QuestionController
{
    ...
    public class BreadcrumbRouteTests : IClassFixture<CustomWebApplicationFactory<Startup>>
    {
        ...
        {
            new object[] { "skills-health-check/question/breadcrumb" },
            new object[] { "skills-health-check/question/answer-question/breadcrumb" },
            new object[] { "skills-health-check/question/answer-multiple-question/breadcrumb" },
            new object[] { "skills-health-check/question/answer-elimination-question/breadcrumb" },
            new object[] { "skills-health-check/question/answer-feedback-question/breadcrumb" },
            new object[] { "skills-health-check/question/answer-checking-question/breadcrumb" },
        };
