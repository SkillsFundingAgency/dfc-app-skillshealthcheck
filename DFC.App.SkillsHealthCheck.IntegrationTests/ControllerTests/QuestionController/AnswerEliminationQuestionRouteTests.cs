...
namespace DFC.App.SkillsHealthCheck.IntegrationTests.ControllerTests.QuestionController
{
    ...
    public class AnswerEliminationQuestionRouteTests : IClassFixture<CustomWebApplicationFactory<Startup>>
    {
        private const string Url = "skills-health-check/question/answer-elimination-question/body";
        private readonly CustomWebApplicationFactory<Startup> factory;

        public AnswerEliminationQuestionRouteTests(CustomWebApplicationFactory<Startup> factory)
        {
        ...
        public async Task PostRequestWithoutActiveSessionRedirectToSessionTimeout()
        {
            ...
            // Act
            var response = await client.PostAsJsonAsync(uri, new EliminationAnswerQuestionViewModel { });
