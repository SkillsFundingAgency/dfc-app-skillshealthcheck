...
namespace DFC.App.SkillsHealthCheck.IntegrationTests.ControllerTests.QuestionController
{
    ...
    public class AnswerMultipleQuestionRouteTests : IClassFixture<CustomWebApplicationFactory<Startup>>
    {
        private const string Url = "skills-health-check/question/answer-multiple-question/body";
        private readonly CustomWebApplicationFactory<Startup> factory;

        public AnswerMultipleQuestionRouteTests(CustomWebApplicationFactory<Startup> factory)
        {
        ...
        public async Task PostRequestWithoutActiveSessionRedirectToSessionTimeout()
        {
            ...
            // Act
            var response = await client.PostAsJsonAsync(uri, new MultipleAnswerQuestionViewModel { });
        ...
        public async Task ValidPostRequestWithActiveSessionRedirectsToNextQuestion()
        {
            ...
            var model = new MultipleAnswerQuestionViewModel
            {
